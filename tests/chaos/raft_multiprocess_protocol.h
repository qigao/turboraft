...
#define TR_CHAOS_RESPONSE_HEADER_SIZE 104U
#define TR_CHAOS_COMMAND_GROUP_OFFSET 16U
#define TR_CHAOS_RESPONSE_GROUP_OFFSET 96U
#define TR_CHAOS_DEFAULT_GROUP_ID UINT64_C(100)
#define TR_CHAOS_GROUP_COUNT 3U
#define TR_CHAOS_GROUP_1 UINT64_C(100)
#define TR_CHAOS_GROUP_2 UINT64_C(200)
#define TR_CHAOS_GROUP_3 UINT64_C(300)
